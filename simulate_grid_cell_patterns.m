...
useRealTrajectory = 0;
constantVelocity = [0.5; 0.3]; %0*[0.5; 0]; % m/s
...
ncells = 60*60; % total number of cells in network
...
dt = 0.5; % time step, ms
simdur = 20000; %100e3; % total simulation time, ms
stabilizationTime = 200; %100; % no-velocity time for pattern to form, ms
